...
export default function CamelUpCup(): JSX.Element {
  const images = [
    {
      original: camelUpGame,
      thumbnail: camelUpGame,
      description: "The box art for Camel Up"
    },
    {
      original: peoplePlaying,
      thumbnail: peoplePlaying,
      description: "Humans Playing the game"
    },
    {
      original: trophy,
      thumbnail: trophy,
      description: "The trophy, to be awarded to the winner"
    },
    {
      original: eventTwo,
      thumbnail: eventTwo,
      description: "The event itself (bots not pictured)"
    },
    {
      original: eventOne,
      thumbnail: eventOne,
      description: "Sir_Humpfree_Bogart's owner (me)"
    }
  ];
    ...
    <div className="bg-background bg-fixed min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <Article title="Camel Up Cup 2K18" subtitle="">
          ...
          <Subarticle subtitle="How the bots work">
